...
/*
QUESTION 4: In order to assess the liability of a data breach, we will need you to provide a count 
...
/*
QUESTION 5: We are interested in how diverse your film offering is as a means of understanding 
how likely you are to keep customers engaged in the future. Please provide a count of unique film 
titles you have in inventory at each store and then provide a count of the unique categories of 
films you provide.
*/
SELECT 
	store_id,
...
replacement cost for the film that is least expensive to replace, the most expensive to replace, 
...
/*
QUESTION 8: We would like to better understand what your customer base looks like. Please provide 
-- a list of all customer identification values, with a count of rentals they have made all time, 
